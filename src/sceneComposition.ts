...
const yodaVaderWide: SceneComposition = {
  ...
  characters: [
    ...
    },
    {
      ...
      width: 34,
      height: 70,
      path: "M78 4 C50 2 28 15 16 38 C5 39 0 47 3 56 C9 68 21 65 32 59 C39 77 52 91 74 98 C65 78 66 61 78 48 C92 33 96 16 78 4 Z",
      delay: 0,
    },
    {
      id: "saber-side",
      ...
      width: 20,
      height: 42,
      path: "M35 4 C57 11 72 25 74 45 C79 60 72 82 55 94 C36 102 19 93 12 76 C5 59 11 40 24 29 C30 20 31 12 35 4 Z",
      delay: 0.64,
    },
  ],
  flashLanes: [
    { id: "left-contour", x: 3, y: 46, width: 24, angle: -18, delay: 0.2 },
    { id: "center-contour", x: 46, y: 41, width: 18, angle: 14, delay: 0.9 },
    { id: "right-contour", x: 81, y: 54, width: 18, angle: -8, delay: 1.45 },
  ],
};
